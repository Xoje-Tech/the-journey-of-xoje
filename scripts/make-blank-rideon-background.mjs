#!/usr/bin/env node
// scripts/make-blank-rideon-background.mjs
// One-off helper: writes a 128×512 transparent PNG that
// scripts/generate-rideon-background.js opens as a blank canvas.
// Mirror of scripts/make-blank-lcs-background.mjs.
//
// Run: node scripts/make-blank-rideon-background.mjs
...
const W = 128;
const H = 512;
const OUT = '/home/hermes/projects/the-journey-of-xoje/scripts/blank-rideon-background.png';
